    ...
    <div className="relative h-full min-h-0 flex flex-row">
      ...
      >
        ...
        >
          ...
          {toolbarVis.intertextual && (
            <button
              type="button"
              onClick={() => setIntertextualOpen((v) => !v)}
              className={[
                "shrink-0 px-[14px] py-[7px] rounded font-medium transition-colors",
                intertextualOpen
                  ? "bg-amber-500 text-white"
                  : "bg-stone-100 dark:bg-stone-800 text-stone-600 dark:text-stone-300 hover:bg-stone-200 dark:hover:bg-stone-700",
              ].join(" ")}
            ...
            <div className="flex items-center gap-1 border-l border-[var(--border)] pl-4">
              ...
              {hasActiveTranslations && (
                <button
                  ...
                  className={["px-3 py-1.5 rounded text-[16px] font-medium transition-colors",
          ...
          <div className="ml-auto">
            <button
              ...
              className={[
                "px-3 py-1.5 rounded text-[23px] font-medium transition-colors",
